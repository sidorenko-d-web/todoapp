...
type AuthStep = 'loading' | 'language' | 'skin' | 'push' | 'invite_code' | 'completed';
...
export function AuthInit({ children }: AuthInitProps) {
  ...
  switch (currentStep) {
    ...
    case 'invite_code':
      return <EnterInviteCodePage onContinue={handleInviteCodeContinue} />;
