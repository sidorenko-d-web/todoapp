...
export default function DevModals() {
  ...
  useEffect(() => {
    ...
    class SpineScene extends Phaser.Scene {
      ...
      preload() {
        const jsonUrl = new URL(`https://storage.yandexcloud.net/miniapp-v2-prod/лампа_base.json`).href;
        const atlasUrl = new URL(`https://storage.yandexcloud.net/miniapp-v2-prod/лампа_baseatlas.txt`).href;
