...
export const IntegrationStats: React.FC<IntegrationStatsProps> = ({
  ...
  return (
    <div className={styles.IntegrationStatsWrp}>
      <div className={`${styles.IntegrationStat} ${elevateStats ? styles.elevated : ''}`}>
        <p className={styles.amount}>{formatAbbreviation(Math.floor(displayedSubscribers), 'number', {locale: locale})}</p>
        <div className={styles.typeWrp}>
      ...
      <div className={`${styles.IntegrationStat} ${elevateStats ? styles.elevated : ''}`}>
        <p className={styles.amount}>{formatAbbreviation(Math.floor(displayedViews), 'number', {locale: locale})}</p>
        <div className={styles.typeWrp}>
      ...
      <div className={`${styles.IntegrationStat} ${elevateStats ? styles.elevated : ''}`}>
        <p className={styles.amount}>{formatAbbreviation(displayedIncome, 'number', {locale: locale})}</p>
        <div className={styles.typeWrp}>
