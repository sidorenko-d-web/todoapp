...
const jsonUrl = new URL(`https://miniapp-v2-prod.website.yandexcloud.net/постер_base.json`).href;
const atlasUrl = new URL(`https://miniapp-v2-prod.website.yandexcloud.net/постер_baseatlas.txt`).href;
